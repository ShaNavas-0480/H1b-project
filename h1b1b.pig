h1b = load '/home/hduser/piginputfile' using PigStorage('\t') as (sno, casestatus, employername, socname, jobtitle:chararray, position, wage:double, year:chararray, lat, log);
